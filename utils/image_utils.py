...
def crop_image(image, crop_size=-1):
    if crop_size == -1:
        return image
    image_height, image_width = image.shape[:2]
    crop_image_height = (crop_size, image_height - crop_size - 1)
    crop_image_width = (crop_size, image_width - crop_size - 1)
    return image[crop_image_height[0]:crop_image_height[1], crop_image_width[0]:crop_image_width[1]]
