...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self.w_normal_prior = None  # "stablenormal_normals"  # "stablenormal_normals"

        self.segmap_dir = "sam/mask"
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.seg_feature_lr = 0.025  # 0.01  # feat

        self.sample_batchsize = 32 * 1024
        self.sample_mv_frames = 5
